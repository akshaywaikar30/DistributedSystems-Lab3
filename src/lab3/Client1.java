...
public class Client1 extends JFrame implements ActionListener 
{
    ...
    { 	
		...
		sendBtn.addActionListener(this);					//adds the TextArea to the container
...
//    								dos.writeUTF(httpMsg + "NEED DECISION");
    ...
    {
    	if(!new File("client1.txt").exists())
    	{
    		logfile = new File("client1.txt");
    		logfile.createNewFile();
    	}
    	else if(new File("client1.txt").exists())
    	{
